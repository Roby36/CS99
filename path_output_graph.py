...
def generate_path_n_surface_graph(
        params, X, Y, A_star_output_path_key,
        z_lim = (0, 5), 
        input_figsize = (10,8)
    ):
...
def main():
    ...
    generate_path_n_surface_graph(params, X, Y, A_star_output_path_key)
